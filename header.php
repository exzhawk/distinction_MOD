        ...
        <div id="branding" role="banner">
            ...
            <<?php echo $heading_tag; ?> id="site-title">
				...
				if ( 'true' == $wpnj_distinction_options['display_header_flames'] ) { // Enabled by default ?>
					<a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><div id="leftwing"><img src="<?php echo get_template_directory_uri(); ?>/images/evil.svg" alt="wispy image" width="90px" height="60px"/></div><?php bloginfo( 'name' ); ?><div id="rightwing"><img src="<?php echo get_template_directory_uri(); ?>/images/angel.svg" alt="wispy image"  width="90px" height="60px"/></div></a> 
